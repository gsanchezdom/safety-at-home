...
icono = "gestor-contraseñas\img.png"  
...
def guardar_texto():
    ...
    with open("gestor-contraseñas\gestor.txt", "a") as archivo:
...
def eliminar_contenido_archivo():
    with open("gestor-contraseñas\gestor.txt", "w") as archivo:
        archivo.truncate(0)

with open("gestor-contraseñas\gestor.txt", "r") as archivo:
